...
zakazdar.`data`,magazin.address,magazin.tel_nomer, zakazdar.price-zakazdar.summa, zakazdar.performance
 FROM zakazdar join magazin join client on 
 zakazdar.magazin_id=magazin.id 
 and 
 (zakazdar.price-zakazdar.summa)>0
  and
...
<a href="index.php?page=karuzb&id=<? echo $row['id']?>">
<div style="
...
<? if($row[7]!='0'):?>
<b style="color: green;">Заказ жеткирип берилген!</b> 
<br>
<? endif; ?>
