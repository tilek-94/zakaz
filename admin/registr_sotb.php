...
<div>
	...
	if (!empty($mag)&&!empty($address)&&
		...
		echo $query="INSERT INTO client(name,data_r,tel_nom,passw)
...
/*$name=$_POST['name'];*/
$query = "SELECT * FROM client WHERE metka='0'  ORDER BY id DESC";
$res1 = mysqli_query($connection,$query);
...
//echo "Данные: ".$_POST['name']."  цифра: ".$_POST['number'];
	...
	<b>Ф.И.О:</b> <? echo $row[1];  ?>

	<br>
	<b>Дата рождения:</b> <? echo $row[2];  ?>
	<br>
	<b>Телефон:</b> <? echo $row[3];  ?>
	<br>
	<b>Пароль:</b> <? echo $row[4];  ?>
